...
<body>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<nav aria-label="breadcrumb mx-auto" role="navigation">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="qnaList.do">MyPage</a></li>
							<li class="breadcrumb-item" aria-current="page">가까운 지점 찾기</li>
						</ol>
					</nav>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f65cb266cf74d0e3589e67ec199c7fe3&libraries=services"></script>
	<script>
		...
		var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
		mapOption = {
			center : new kakao.maps.LatLng(35.8690730613163, 128.593296913547), // 지도의 중심좌표
		...
		window.onload = function() {
			document.getElementById('BK9').click();
		}
	</script>
</body>
</html>